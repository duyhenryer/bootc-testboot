...
When building disk images with bootc-image-builder, the config.toml can include initial users (passwords, SSH keys). These become machine-local state at first boot. See [005-manual-deployments.md](../project/005-manual-deployments.md) (Section 2: bootc-image-builder Reference).
